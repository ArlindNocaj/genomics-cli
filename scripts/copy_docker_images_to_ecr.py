#!/usr/bin/env python
"""
script from https://github.com/wellcomecollection/platform-infrastructure/blob/4b16beef44efbe8faa9a62f5459ab6f706e07032/builds/copy_docker_images_to_ecr.py
...
ACCOUNT_ID = os.getenv("ACCOUNT_ID","12345678")

IMAGE_TAGS = list(sys.argv)[1:]
print("IMAGE_TAGS: "+ str(IMAGE_TAGS))
